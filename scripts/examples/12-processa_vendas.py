...
try:
    ...
    # Nao usar sys.exit aqui em um plugin para evitar quebrar o parse do Airflow completamente
    raise # Relanca para o Airflow lidar

# Importação da classe base do Airflow para override.
try:
...
"""
====================================================================================
MODULO: SEGURANCA DO AIRFLOW COM INTEGRACAO DE AUDITORIA 
====================================================================================
