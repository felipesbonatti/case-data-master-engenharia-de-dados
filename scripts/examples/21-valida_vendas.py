...
try:
    # Embora este script standalone não use diretamente o Vault para as expectativas,
    # Deixei a estrutura para exemplificar um ambiente onde a validação
    # é parte de um ecossistema seguro. Se fosse buscar expectativas do Vault, seria aqui.
